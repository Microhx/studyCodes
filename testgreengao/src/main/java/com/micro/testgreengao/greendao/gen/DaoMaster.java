...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        SuccessfulManDao.createTable(db, ifNotExists);
        BookDao.createTable(db, ifNotExists);
        CityDao.createTable(db, ifNotExists);
        CityAndBooksDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        SuccessfulManDao.dropTable(db, ifExists);
        BookDao.dropTable(db, ifExists);
        CityDao.dropTable(db, ifExists);
        CityAndBooksDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(SuccessfulManDao.class);
        registerDaoClass(BookDao.class);
        registerDaoClass(CityDao.class);
        registerDaoClass(CityAndBooksDao.class);
